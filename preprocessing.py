...
class img_dataset(Dataset):
    ...
    def __len__(self):
        return len(self.set)
#     def size(self):
#         return self.data_dir.shape

    def __getitem__(self, item):
#         file_name = os.path.join(self.data_dir,self.set[item])
#         print('file_name',file_name)
        img_batch = pickle.load(open(self.set[item], 'rb'))
        if self.sample:
            sampled_img_batch = []
...
#                 print('seg',img_ext.seg)
                ...
                sampled_img_batch.append(utils.img_extended(img,\
                                                            ...
                                                            None,
                                                            coord,
                                                            np.array([img_ext.cid])))
            img_batch = sampled_img_batch
